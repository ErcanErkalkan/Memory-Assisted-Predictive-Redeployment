...
Outputs are written to _supp_work/results with the ablation_all20_ prefix.
...
if (ROOT / "src" / "dynamic_prr_experiment.py").exists():
    SUPP_ROOT = ROOT
elif (ROOT / "_supp_work" / "src" / "dynamic_prr_experiment.py").exists():
    SUPP_ROOT = ROOT / "_supp_work"
else:
    raise FileNotFoundError("Could not locate _supp_work/src/dynamic_prr_experiment.py or src/dynamic_prr_experiment.py")
SRC = SUPP_ROOT / "src"
